...
namespace OrganizerCompanion.Core.UnitTests.DataTransferObjects
{
    ...
    internal class ProjectAssignmentDTOShould
    {
        ...
        public void HaveJsonConstructorWithAllParameters()
        {
            ...
            // Act
            var projectAssignmentDTO = new ProjectAssignmentDTO(
                id, name, description, assigneeId, assignee, locationId, locationType, location, groups, taskId, task, isCompleted,
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(projectAssignmentDTO.AssigneeId, Is.EqualTo(assigneeId));
        ...
        public void CoverAllJsonConstructorParameters()
        {
            ...
            var dto = new ProjectAssignmentDTO(
                id, name, description, assigneeId, assignee, locationId, locationType, location, groups, taskId, task,
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(dto.AssigneeId, Is.EqualTo(assigneeId));
