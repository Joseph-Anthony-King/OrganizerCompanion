...
namespace OrganizerCompanion.Core.Models.DataTransferObject
{
    ...
    List<IEmailDTO> IUserDTO.Emails { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    List<IPhoneNumberDTO> IUserDTO.PhoneNumbers { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
  }
}
